    ...
    <div class="row spread">
      <div class="col-md-4">
        <div id="qz-connection" class="panel panel-default">
          <div class="panel-heading">
            <button class="close tip" data-toggle="tooltip" title="Launch QZ" id="launch" href="#" onclick="launchQZ();"
              style="display: none;">
            ...
            <div class="btn-toolbar">
              <div class="btn-group" role="group">
                ...
                <button id="toggleConnectionGroup" type="button" class="btn btn-success"
                  ...
                  title="Connect to QZ Tray running on a print server"><span
        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <div class="btn-group" role="group">
                <button type="button" class="btn btn-default btn-sm"
                  onclick="findPrinter($('#printerSearch').val(), true);">Find Printer</button>
                <button type="button" class="btn btn-default btn-sm" onclick="findDefaultPrinter(true);">Find Default
                  Printer</button>
                <button type="button" class="btn btn-default btn-sm" onclick="findPrinters();">Find All
                  Printers</button>
              </div>
              <div class="btn-group" role="group">
                <button type="button" class="btn btn-default btn-sm" onclick="detailPrinters();">Get Printer
                  Details</button>
              </div>
            </div>
            <hr />
            ...
            <div class="form-group">
              <div class="btn-group" role="group">
                <button type="button" class="btn btn-default btn-sm"
                  onclick="setPrinter($('#printerSearch').val());">Set To Search</button>
                <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#askFileModal">Set
                  To File</button>
                <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#askHostModal">Set
                  To Host</button>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-8">
        <ul class="nav nav-tabs" role="tablist">
          <li id="rawTab" role="presentation" class="active"><a href="#rawContent" role="tab" data-toggle="tab">Raw
              Printing</a></li>
          ...
          <li id="statusTab" role="presentation"><a href="#statusContent" role="tab" data-toggle="tab">Printer
              Status</a></li>
              ...
              <div class="form-group">
                ...
                <div class="btn-group">
                  <button type="button" class="btn btn-default"
                    onclick="printFile('zpl_sample.txt');">zpl_sample.txt</button>
                  <button type="button" class="btn btn-default"
                    onclick="printFile('fgl_sample.txt');">fgl_sample.txt</button>
                  <button type="button" class="btn btn-default"
                    onclick="printFile('epl_sample.txt');">epl_sample.txt</button>
                  <button type="button" class="btn btn-default"
                    onclick="printFile('sbpl_sample.txt');">sbpl_sample.txt</button>
                </div>
              </div>
            </div>
                ...
                <div class="panel-body">
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group form-inline">
                          <label class="tip" for="rawAltPrinting" data-toggle="tooltip"
                            title="Bypass driver when using CUPS">
                            Alternate Printing
                          </label>
                        ...
                        <div class="form-group form-inline">
                          <label class="tip" for="rawJobName" data-toggle="tooltip"
                            title="Job title as it appears in print queue">
                            Job Name
                          </label>
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group form-inline">
                          <label class="tip" for="pDotDensity" data-toggle="tooltip" title="For ESCPOS only">Dot
                            Density</label>
                        ...
                        <div class="form-group form-inline">
                          <label for="pRawWidth" class="tip" data-toggle="tooltip" title="In pixels">Render
                            Width</label>
                          <input type="number" id="pRawWidth" class="form-control pull-right" />
                        </div>
                        <div class="form-group form-inline">
                          <label for="pRawHeight" class="tip" data-toggle="tooltip" title="In pixels">Render
                            Height</label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button type="button" class="btn btn-danger pull-right"
                        onclick="resetRawOptions();">Reset</button>
                    </div>
                  </div>
                ...
                <div class="panel-body">
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group form-inline">
                          <label class="tip" for="pxlJobName" data-toggle="tooltip"
                            title="Job title as it appears in print queue">
                            Job Name
                          </label>
                        ...
                        <div class="form-group form-inline">
                          ...
                          <input disabled type="number" step="any" id="pxlPaperThickness"
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="checkbox" id="pxlDensityAsymm"
                            onclick="checkGroupActive('pxlDensityAsymm', 'pxlDensityGroup', 'pxlDensity');">
                          )
                        ...
                        <div class="form-group">
                          <label for="pxlMargins" class="tip" data-toggle="tooltip"
                            title="In relation to units specified">Margins</label>
                          (
                          <label for="pxlMarginsActive" class="inline">Individual:</label>
                          <input type="checkbox" id="pxlMarginsActive"
                            onclick="checkGroupActive('pxlMarginsActive', 'pxlMarginsGroup', 'pxlMargins');">
                          )
                        ...
                        <div class="form-group">
                          ...
                          <input type="checkbox" id="pxlSizeActive"
                            onclick="checkGroupActive('pxlSizeActive', 'pxlSizeGroup');" />
                          )
                        </div>
                        <div class="inline" id="pxlSizeGroup">
                          <div class="form-group form-inline">
                            <label for="pxlSizeWidth" class="tip" data-toggle="tooltip"
                              title="In relation to units specified">
                              &nbsp; Width:
                            </label>
                            <input type="number" step="any" id="pxlSizeWidth" class="form-control pull-right" />
                          </div>
                          <div class="form-group form-inline">
                            <label for="pxlSizeHeight" class="tip" data-toggle="tooltip"
                              title="In relation to units specified">
                              &nbsp; Height:
                            </label>
                        ...
                        <div class="form-group">
                          ...
                          <input type="checkbox" id="pxlBoundsActive"
                            onclick="checkGroupActive('pxlBoundsActive', 'pxlBoundsGroup');" />
                          )
                        </div>
                        <div class="inline" id="pxlBoundsGroup">
                          <div class="form-group form-inline">
                            <label for="pxlBoundX" class="tip" data-toggle="tooltip"
                              title="In relation to units specified">
                              &nbsp; X:
                            </label>
                          ...
                          <div class="form-group form-inline">
                            <label for="pxlBoundY" class="tip" data-toggle="tooltip"
                              title="In relation to units specified">
                              &nbsp; Y:
                            </label>
                          ...
                          <div class="form-group form-inline">
                            <label for="pxlBoundWidth" class="tip" data-toggle="tooltip"
                              title="In relation to units specified">
                              &nbsp; Width:
                            </label>
                          ...
                          <div class="form-group form-inline">
                            <label for="pxlBoundHeight" class="tip" data-toggle="tooltip"
                              title="In relation to units specified">
                              &nbsp; Height:
                            </label>
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group form-inline">
                          <label for="pPxlWidth" class="tip" data-toggle="tooltip"
                            title="In relation to units specified">
                            Render Width
                          </label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group form-inline">
                          <label for="pPxlHeight" class="tip" data-toggle="tooltip"
                            title="In relation to units specified">
                            Render Height
                          </label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button type="button" class="btn btn-danger pull-right"
                        onclick="resetPixelOptions();">Reset</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="checkbox" id="serialNewline"
                            onclick="checkItemsDisabled('serialNewline', [ 'serialStart', 'serialEnd', 'serialWidth', 'serialHeader' ]);" />
                        </div>
                        <div class="form-group">
                          <label class="inline">Length Bytes</label>
                          (
                          <label for="serialLengthActive" class="inline">Enable:</label>
                          <input type="checkbox" id="serialLengthActive"
                            onclick="checkGroupActive('serialLengthActive', 'serialLengthGroup');" />
                          )
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="checkbox" id="serialCrcActive"
                            onclick="checkGroupActive('serialCrcActive', 'serialCrcGroup');" />
                          )
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button type="button" class="btn btn-danger pull-right"
                        onclick="resetSerialOptions();">Reset</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="btn-toolbar">
                  <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-info" onclick="listUsbDeviceInterfaces();">List
                      Interfaces</button>
                    <button type="button" class="btn btn-info" onclick="listUsbInterfaceEndpoints();">List
                      Endpoints</button>
                  </div>
                  <div class="btn-group">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group form-inline">
                        ...
                        <input type="text" id="usbVendor" class="form-control pull-right"
                          onblur="formatHexInput('usbVendor')" />
                      </div>

                      <div class="form-group form-inline">
                        <label for="usbProduct">Product ID</label>
                        <input type="text" id="usbProduct" class="form-control pull-right"
                          onblur="formatHexInput('usbProduct')" />
                      </div>

                      <div class="form-group form-inline">
                        <label for="usbInterface">Device Interface</label>
                        <input type="text" id="usbInterface" class="form-control pull-right"
                          onblur="formatHexInput('usbInterface')" />
                      </div>

                      <div class="form-group form-inline">
                        <label for="usbEndpoint">Interface Endpoint</label>
                        <input type="text" id="usbEndpoint" class="form-control pull-right"
                          onblur="formatHexInput('usbEndpoint')" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group form-inline">
                      ...
                      <div class="form-group form-inline">
                        <label for="usbStream" class="tip" data-toggle="tooltip"
                          title="Streaming Only: In milliseconds">
                          Stream Interval
                        </label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button type="button" class="btn btn-danger pull-right"
                        onclick="resetUsbOptions();">Reset</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group form-inline">
                        ...
                        <input type="text" id="hidVendor" class="form-control pull-right"
                          onblur="formatHexInput('hidVendor')" />
                      </div>

                      <div class="form-group form-inline">
                        <label for="hidProduct">Product ID</label>
                        <input type="text" id="hidProduct" class="form-control pull-right"
                          onblur="formatHexInput('hidProduct')" />
                      </div>
                      ...
                      <div class="form-group form-inline">
                        ...
                        <input type="text" id="hidUsagePage" class="form-control pull-right"
                          onblur="formatHexInput('hidUsagePage')" />
                      </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group form-inline">
                        <label for="hidStream" class="tip" data-toggle="tooltip"
                          title="Streaming Only: In milliseconds">
                          Stream Interval
                        </label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button type="button" class="btn btn-danger pull-right"
                        onclick="resetHidOptions();">Reset</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="btn-toolbar">
                  <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-success"
                      onclick="startPrintersListen($('#configPrinter').text())">
                      Current Printer
                    </button>
                    <button type="button" class="btn btn-default" onclick="getPrintersStatus()">Request current
                      status</button>
                  </div>
                  <div class="btn-group">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button type="button" class="btn btn-danger pull-right"
                        onclick="clearPrintersLog();">Clear</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <div class="btn-toolbar">
                  <div class="btn-group">
                    <button type="button" class="btn btn-default" onclick="startFileListen()">Listen for Folder
                      Events</button>
                    <button type="button" class="btn btn-default" onclick="stopFileListen()">Stop Listening</button>
                  </div>
                  <button type="button" class="btn btn-default" onclick="stopAllFileListeners();">Stop All
                    Listeners</button>
                </div>
              </div>
            </div>
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label for="includePattern" class="tip" data-toggle="tooltip"
                          title="File pattern to match when listening for file events (e.g. *.txt)">
                          Include File Pattern
                        </label>
                        <input type="text" id="includePattern" class="form-control pull-right" />
                      </div>
                      <div class="form-group">
                        <label for="excludePattern" class="tip" data-toggle="tooltip"
                          title="File pattern to ignore when listening for file events (e.g. *.tmp) ">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group form-inline">
                        ...
                        <input type="checkbox" id="fileListenerData" class="pull-right"
                          onclick="checkGroupActive('fileListenerData', 'fileTriggersGroup')" />
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button type="button" class="btn btn-danger pull-right"
                        onclick="resetFileOptions();">Reset</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="form-group">
              ...
              <hr />
              <p><span class="text-danger" style="font-weight:bold;"><span class="fa fa-warning"></span> WARNING:</span>
                This feature has been deprecated. Please configure a local raw <code>FILE:</code> printer, or use
                <code>File IO</code></a> instead. For more
                information please see <a
                  href="https://github.com/qzind/tray/issues/730">issue&nbsp;<code>#730</code>.</a></p>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  qz.security.setCertificatePromise(function (resolve, reject) {
    ...
    fetch("/cert.php", {cache: 'no-store', headers: {'Content-Type': 'text/plain'}})
  ...
  qz.security.setSignaturePromise(function (toSign) {
    return function (resolve, reject) {
      //Preferred method - from server
      fetch("/server.php?request=" + toSign, {cache: 'no-store', headers: {'Content-Type': 'text/plain'}})
        .then(function(data) { data.ok ? resolve(data.text()) : reject(data.text()); });
    };
  });
